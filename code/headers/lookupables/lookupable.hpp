...
namespace r2d2::thermal_camera {
    ...
    protected:
         ...
         */
        int get_pixel_number(unsigned int row, unsigned int col) const;

    public:
        lookupable_c(mlx90640_i2c_c &bus, mlx_parameters_s &params);
        /**
         * Sets the calibration parameter in lookupable_c::table, given a row,
         * col.
         *
         ...
         */
        float get_value(unsigned int row, unsigned int col);
    };
} // namespace r2d2::thermal_camera