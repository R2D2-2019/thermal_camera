...
//I2C i2c(p9, p10);     
auto i2c = r2d2::i2c::i2c_bus_c(r2d2::i2c::i2c_bus_c::interface::interface_0, 50000); 
void MLX90640_I2CInit()
{   
   // i2c.stop();
}

// int MLX90640_I2CRead1(uint8_t slaveAddr, uint16_t startAddress, uint16_t nMemAddressRead, uint16_t *data)
// {
//     uint8_t sa;                           
//     int ack = 0;                               
//     int cnt = 0;
