...
namespace r2d2::thermal_camera {
    ...
    void ee_corner_temp_c::extract() {
        ...
        int step = data_extractor::extract_data(data, 0x3000, 12) * 10;
        params.ct3 =
            data_extractor::extract_and_treshold(data, 0x00F0, 4) * step;
        params.ct3 =
            data_extractor::extract_and_treshold(data, 0x0F00, 8) * step +
            params.ct3;
    }
} // namespace r2d2::thermal_camera
